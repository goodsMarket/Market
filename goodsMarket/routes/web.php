...
Route::middleware('trim')->group(function () {
    ...
    // 게시글
    Route::get('/list', [ListController::class, 'index_ut']);
    // 리스트 출력
    Route::prefix('/list')->group(function () {
        Route::get('/used-trade', [ListController::class, 'index_ut']);
        // Route::get('/used-trade/deleted/{page}', [ListController::class, 'index_deleted_ut']);
        Route::get('/used-trade/{page}', [ListController::class, 'index_ut']);
    });
    Route::prefix('/board')->group(function () {
        // 게시글 crud
        Route::get('/used-trade/{id}', [UsedTradeControlloer::class, 'view_ut']);
        Route::post('/used-trade/deleted', [UsedTradeControlloer::class, 'view_deleted_ut']);
        // 로그인 해야함
